...
parsley:function(c){var g=0,f=0,h=10,n=100;for(k=1;k<c.length;k++)c[k]&&(g=g?g:k,f=k);switch(f){case 9:h=16;case 1:b[0]=b[1]=b[2]=parseInt(c[f],h);break;case 12:h=16,n=255;case 4:b[3]=c[f].match(/%/g)||12==f?parseInt(c[f],h)/n:parseFloat(c[f]);case 11:h=11==f?16:h;case 3:for(i=0;3>i;i++)b[i]=parseInt(c[g+i],h);break;case 8:n=15,b[3]=parseInt(c[f],16)/n;case 7:h=16;for(i=0;3>i;i++)b[i]=parseInt(c[g+i]+c[g+i],h);break;case 17:b[3]=c[f].match(/%/g)?parseInt(c[f],h)/n:parseFloat(c[f]);case 16:b[5]=
